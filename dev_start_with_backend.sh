...
# Children of the Singularity - Development Startup Script WITH BACKEND
# This script starts both the backend API and Godot game for backend development/testing
#
# 🎯 USE THIS WHEN:
# • Testing backend API integration
# • Developing new API endpoints
# • Testing database functionality
# • Working on server-side features
#
# 🎯 USE dev_start.sh WHEN:
# • Testing release environment (default)
# • Working on local-first features
# • Testing offline functionality
# • Verifying game works without backend

set -e  # Exit on any error

echo "🚀 Starting Children of the Singularity Development Environment WITH BACKEND"
echo "============================================================================="
